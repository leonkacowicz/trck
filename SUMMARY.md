...
### [#6ezbd38 ready: only offer work nobody has started](items/6ezbd38-ready-only-offer-work-nobody-has-started.md) — 100% (5/5 pts · 4/4 done) · _medium_ · done
...
- [x] [#vhzs9jx trck-html: present ready as a board column, not a badge](items/vhzs9jx-trck-html-present-ready-as-a-board-column-not-a-badge.md)
- [x] [#vqtt8dt list: a distinct gutter glyph for ready rows](items/vqtt8dt-list-a-distinct-gutter-glyph-for-ready-rows.md)
...
- [x] [#a2cdsa8 a closed pipe panics instead of exiting quietly](items/a2cdsa8-a-closed-pipe-panics-instead-of-exiting-quietly.md)
...
- [x] [#snfw9cn release.yml fires on any v* tag, including a Python one](items/snfw9cn-release-yml-fires-on-any-v-tag-including-a-python-one.md)
...
### [#sqzr7nk storage: move the tracker to an orphan trck-issues branch](items/sqzr7nk-storage-move-the-tracker-to-an-orphan-trck-issues-branch.md) — 100% (61/61 pts · 30/30 done) · _high_ · done
...
- [x] [#8d22h6x main: remove issues/ — the flip](items/8d22h6x-main-remove-issues-the-flip.md)
...
- [x] [#9gxktnk writes: replay stacked pending commits, and surface an op that no longer applies](items/9gxktnk-writes-replay-stacked-pending-commits-and-surface-an-op-that-no-longer-applies.md) · [review](https://github.com/leonkacowicz/trck/pull/48)
...
- [x] [#ch5furb diff: says 'working tree' when the tracker is a ref and there is none](items/ch5furb-diff-says-working-tree-when-the-tracker-is-a-ref-and-there-is-none.md) · [review](https://github.com/leonkacowicz/trck/pull/59)
...
- [x] [#mhc8k3k repo setup-git and install-hook say 'not a git repository' against a ref tracker](items/mhc8k3k-repo-setup-git-and-install-hook-say-not-a-git-repository-against-a-ref-tracker.md) · [review](https://github.com/leonkacowicz/trck/pull/64)
...
- [x] [#r79v4va retire path, which and list --paths once --contains replaces them](items/r79v4va-retire-path-which-and-list-paths-once-contains-replaces-them.md) [tracker-features]
...
- [x] [#ubvkhds list --contains PATTERN: body search as a filter, not a pipeline](items/ubvkhds-list-contains-pattern-body-search-as-a-filter-not-a-pipeline.md) [tracker-features]
...
### [#tcm5s56 serve: a live process over the tracker ref, with writes from the page](items/tcm5s56-v7-trck-serve-live-process-edits-write-back-to-index-jsonl.md) — 80% (4/5 pts · 4/5 done) · _low_ · in-progress
...
- [x] [#us8fenh serve: SSE re-render — ref movement pushes to open pages](items/us8fenh-serve-sse-re-render-ref-movement-pushes-to-open-pages.md) · [review](https://github.com/leonkacowicz/trck/pull/70)
...
- [#resmtnz conformance: a fixture that spells the version out breaks on every bump](items/resmtnz-conformance-a-fixture-that-spells-the-version-out-breaks-on-every-bump.md) — _low_
...
- [#xrbb53h pay down finalize, the single write path](items/xrbb53h-pay-down-finalize-the-single-write-path.md) — _medium_ (closed 2026-08-09)
