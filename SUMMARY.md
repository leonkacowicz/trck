...
### [#sqzr7nk storage: move the tracker to an orphan trck-issues branch](items/sqzr7nk-storage-move-the-tracker-to-an-orphan-trck-issues-branch.md) — 59% (32/54 pts · 13/23 done) · _high_ · in-progress
...
- [ ] [#5w9d7sq writes: push with CAS, refetch on rejection, replay the pending commit](items/5w9d7sq-writes-push-with-cas-refetch-on-rejection-replay-the-pending-commit.md) _(in-review)_ · [review](https://github.com/leonkacowicz/trck/pull/43)
