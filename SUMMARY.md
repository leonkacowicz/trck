...
### [#sqzr7nk storage: move the tracker to an orphan trck-issues branch](items/sqzr7nk-storage-move-the-tracker-to-an-orphan-trck-issues-branch.md) — 97% (59/61 pts · 28/30 done) · _high_ · in-progress
...
- [ ] [#r79v4va retire path, which and list --paths once --contains replaces them](items/r79v4va-retire-path-which-and-list-paths-once-contains-replaces-them.md) [tracker-features] _(backlog)_
...
- [ ] [#ubvkhds list --contains PATTERN: body search as a filter, not a pipeline](items/ubvkhds-list-contains-pattern-body-search-as-a-filter-not-a-pipeline.md) [tracker-features] _(in-progress)_
