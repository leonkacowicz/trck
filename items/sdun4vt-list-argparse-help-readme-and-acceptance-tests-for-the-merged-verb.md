...
Phase 5 of #qapvxpz — the closing polish for the merged browse verb. Wire up the surface and
documentation, and land the full acceptance-test pass against #qapvxpz's criteria.
...
- acceptance tests covering each #qapvxpz criterion end to end.
...
- [ ] Acceptance tests cover every #qapvxpz checkbox; `trck check` passes.

## Notes

Final child of #qapvxpz — the epic is done when this closes.
