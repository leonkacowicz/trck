...
### [#r9zefup Add --json output to list/show/deps/tree for scripting](items/r9zefup-add-json-output-to-list-show-deps-tree-for-scripting.md) — 0% (0/6 pts · 0/6 done) · _low_ · ongoing
...
- [ ] [#v8tmkrt json: shared emit_json stdout seam + --json flag plumbing](items/v8tmkrt-json-shared-emit-json-stdout-seam-json-flag-plumbing.md) _(ongoing)_
