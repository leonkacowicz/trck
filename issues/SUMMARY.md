...
### [#ey2aruc Auto-resolve index.jsonl and SUMMARY.md merge conflicts via git merge drivers](items/ey2aruc-auto-resolve-index-jsonl-and-summary-md-merge-conflicts-via-git-merge-drivers.md) — 70% (7/10 pts · 3/4 done) · _low_ · ongoing

- [ ] [#2ry5d58 integration tests: real git merges and rebases in all three directions](items/2ry5d58-integration-tests-real-git-merges-and-rebases-in-all-three-directions.md) _(ongoing)_
