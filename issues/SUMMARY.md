...
### [#r9zefup Add --json output to list/show/deps/tree for scripting](items/r9zefup-add-json-output-to-list-show-deps-tree-for-scripting.md) — 50% (3/6 pts · 3/6 done) · _low_ · ongoing
...
- [ ] [#k9snjz3 list --json: nested hierarchy (and --flat --json flat array)](items/k9snjz3-list-json-nested-hierarchy-and-flat-json-flat-array.md) _(ongoing)_
