...
### [#r9zefup Add --json output to list/show/deps/tree for scripting](items/r9zefup-add-json-output-to-list-show-deps-tree-for-scripting.md) — 33% (2/6 pts · 2/6 done) · _low_ · ongoing

- [ ] [#57kz6xp deps --json: {requires, blocks} cones as JSON](items/57kz6xp-deps-json-requires-blocks-cones-as-json.md) _(ongoing)_
